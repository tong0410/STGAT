...
To run this code, you should first prepare some of the datasets in "data" folder. Create your "protein name" as  folder name  in "data". And it should contain edges features and nodes features in "protein name" folder. Different numpy files represent different features. And you should prepare nodes features and edges features separately. 
